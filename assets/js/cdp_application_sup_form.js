...
$(document).ready(function () {
    ...
    $("input[type=radio][name=per_employer_design_office], input[type=radio][name=per_employer_design_office_iesl]").on("change", function (event) {
        event.preventDefault();

        if($("#design_office_y").prop('checked') && $("#design_office_iesl_y").prop('checked')){
    ...
    $("input[type=radio][name=per_employer_design_office]").on("change", function (event) {
        ...
        if($("#design_office_y").prop('checked')){
            $("#design_office_iesl_y").prop('required', true);
        }else{
            $("#design_office_iesl_y").prop('required', false);
        }
    });
