...
class CI_Application_export {
    ...
    public function getNormalApplicationDetails($user_tbl_id) {
        ...
        $this->CI->db->select('*, master_types_of_institutions.type_of_institution_type AS type_of_institution_type, iesl_recognized_institute.inst_name AS institute_name, member_academic_qualifications.state AS state');
        $this->CI->db->from('member_academic_qualifications');
        $this->CI->db->join('iesl_recognized_institute', 'iesl_recognized_institute.institute_id = member_academic_qualifications.institute_name', 'left');
    ...
    public function getTechengApplication($user_tbl_id) {
        ...
        $this->CI->db->select('*, master_types_of_institutions.type_of_institution_type AS type_of_institution_type, iesl_recognized_institute.inst_name AS institute_name, techeng_academic_qualifications.state AS state');
        $this->CI->db->from('techeng_academic_qualifications');
        $this->CI->db->join('iesl_recognized_institute', 'iesl_recognized_institute.institute_id = techeng_academic_qualifications.institute_name', 'left');
    ...
    public function getReinstatementApplicationDetail($rein_tbl_id) {
        ...
        $this->CI->db->select('*, master_types_of_institutions.type_of_institution_type AS type_of_institution_type, iesl_recognized_institute.inst_name AS institute_name_word, member_reinstatement_academic_qualifications.state AS state');
        $this->CI->db->from('member_reinstatement_academic_qualifications');
        $this->CI->db->join('iesl_recognized_institute', 'iesl_recognized_institute.institute_id = member_reinstatement_academic_qualifications.institute_name', 'left');
...
//        $this->CI->db->join('iesl_recognized_institute', 'iesl_recognized_institute.institute_id = mem_transfer_academic_qualifications.institute_name', 'left');
    ...
    public function getRecoverApplication($rein_tbl_id){
        ...
        $this->CI->db->select('*, master_types_of_institutions.type_of_institution_type AS type_of_institution_type, iesl_recognized_institute.inst_name AS institute_name_word, member_recover_academic_qualifications.state AS state');
        $this->CI->db->from('member_recover_academic_qualifications');
        $this->CI->db->join('iesl_recognized_institute', 'iesl_recognized_institute.institute_id = member_recover_academic_qualifications.institute_name', 'left');
