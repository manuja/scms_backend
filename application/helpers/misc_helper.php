...
function fireEmailNotification($values)
{
    ...
    $CI->email_lib->sendEmail('pavan.pipl@gmail.com', $values['receiverAddress'], $values['mailSubject'], $values['mailBody']);
}
    ...
    <div  class="modal-content">
      ...
      <div  class="modal-body alignrecord">
        ...
        <p align="center">  <!-- <input class="btn btn-success " id="saveEventBtn" value="Pay Online" type="button" name="payonline"> -->
             <button type="button" onclick="goIPGBOC()" class="btn btn-default pay_btn"><img src="<?php echo site_url(); ?>assets/images/boc1.png"></button><button type="button" onclick="goIPGSampath()"  class="btn btn-default pay_btn"><img src="<?php echo site_url(); ?>assets/images/sam1.png"></button></p>
      </div>
