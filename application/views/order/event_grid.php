          ...
          <div class="box-header">
            ...
            <div class="box-tools">
              <?php if ($this->ion_auth->is_admin() || $this->userpermission->checkUserPermissions2('add_event')) { ?>
                <a href="<?php echo site_url('event_management/add_events'); ?>" class="btn btn-primary">Add Events</a>
              <?php } ?>
            </div>
          </div>
                  ...
                  foreach ($events as $event) {  ?>
                    ...
                    <tr>
                      ...
                      <td>
                        ...
                        $applydate =  date('Y-m-d', strtotime($event['date']));
                      ...
                      <td>
                        <?php if ($this->userpermission->checkUserPermissions2('view_event')) { ?>
                          <a data-toggle="modal" data-toggle="tooltip" title="View" id="loadmodalview" href="<?php echo base_url('index.php/event_management/view_events/' . $event['id']) ?>" class="btn btn-success"><i class="fa  fa-eye"></i></a>
                        <?php } ?>
                        ...
                        <?php if ($this->userpermission->checkUserPermissions2('edit_event')) { ?>
                          <a data-toggle="tooltip" title="Edit" href="<?php echo base_url('index.php/event_management/edit_events/' . $event['id']) ?>" class="btn btn-warning"><i class="fa  fa-edit"></i></a>
                        <?php } ?>
