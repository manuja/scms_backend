                        ...
                        <div class="panel panel-default">
                            <div class="panel-body">
                                <div class="four-zero-three">
                                    <div class="inner">
                                        <p>&nbsp;</p>
                                        <p style="font-size: 1.2em;line-height: 2.1;font-weight: 700;">Once you submitted your application, IESL staff will review it and successful candidates will be notified about the application payment. Application payment will be different from class of membership that you are applying.</p>
                                        <p>&nbsp;</p>
