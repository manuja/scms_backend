        ...
        <ul class="sidebar-menu" data-widget="tree">
            ...
            <?php if ($CI->ion_auth->is_admin())
            {
                ...
                <li class="treeview">
                    ...
                    <ul class="treeview-menu">
                        <li><a href="<?php echo site_url('users'); ?>"><i class="fa fa-circle-o"></i>All Users</a></li>
                        <li><a href="<?php echo site_url('groups'); ?>"><i class="fa fa-circle-o"></i>All Groups</a></li>
                         <li><a href="<?php echo site_url('User_permissions_new'); ?>"><i class="fa fa-circle-o"></i> User Permissions</a></li>
                        <li><a href="<?php echo site_url('Group_permissions_new'); ?>"><i class="fa fa-circle-o"></i> Group Permissions</a></li>
                ...
                <!-- <li class="treeview">
                    ...
                    <ul class="treeview-menu">
                        <li><a href="<?php echo site_url('member-management'); ?>"><i class="fa fa-circle-o"></i>Member Management</a></li>
                ...
                <!-- <li class="treeview">
                    ...
                    <ul class="treeview-menu">                        
                        <li><a href="<?php echo site_url('master/Class_of_Notification_Category'); ?>"><i class="fa fa-circle-o"></i> Notification categories</a></li>
                        <li><a href="<?php echo site_url('master/Class_of_Notification_Priority'); ?>"><i class="fa fa-circle-o"></i> Notification priority</a></li>
                ...
                <li class="treeview">
                    ...
                    <ul class="treeview-menu">
                        <li><a href="<?php echo site_url('audit/user-management'); ?>"><i class="fa fa-circle-o"></i>User Management Module</a></li>
                    </ul>
               ...
               <!--  <li class="treeview">
                    ...
                    <ul class="treeview-menu">
                        <li><a href="<?php echo site_url('system_menu'); ?>"><i class="fa fa-circle-o"></i> System Menu</a></li>
                        <li><a href="<?php echo site_url('permissions'); ?>"><i class="fa fa-circle-o"></i> System Permissions</a></li>
                        <li><a href="<?php echo site_url('access_control_matrix'); ?>"><i class="fa fa-circle-o"></i>Access control matrix</a></li>
                    </ul>
                </li> -->
